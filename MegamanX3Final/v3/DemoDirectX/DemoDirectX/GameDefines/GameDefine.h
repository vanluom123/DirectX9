...
namespace Define
{
	...
	const char HEAD_GUNNER_SPRITE[]      = "Resources/Enemies/HeadGunnerCustomer/head-gunner-sprite.png";
	const char HEAD_GUNNER_BULLET[]      = "Resources/Enemies/HeadGunnerCustomer/head-gunner-bullet.png";
	...
	const char HELIT_SPRITE_SHEET[]      = "Resources/Enemies/Helit/helit-sprite.png";
	const char HELIT_BULLET[]            = "Resources/Enemies/Helit/helit-sprite-bullet.png";
	const char HELIT_DIE[]               = "Resources/Enemies/Helit/helit-death.png";

	const char CARRY_ARM[]               = "Resources/Enemies/CarryArm/carry-arm-sprite.png";

	const char GENJIBO_SHURIKEIN[]       = "Resources/Enemies/Genjibo/shurikein-sprite.png";
	const char SHURIKEN[]                = "Resources/Enemies/Genjibo/genjibo-sprite.png";

	const char BURST[]                   = "Resources/Enemies/Burst.png";
	const char EXPLOSIONS[]				 = "Resources/Enemies/Explosions/red-explosion-sprite.png";
