...
public:
    ...
    /// Visit an SpringBoardn node.
    virtual bool Visit( const XMLSpringBoardn& /*SpringBoardn*/ )				{
        return true;
    }
};
...
enum XMLError {
    ...
    XML_ERROR_PARSING_SpringBoardN,
...
public:
    ...
    /// Safely cast to an SpringBoardn, or null.
    virtual XMLSpringBoardn*		ToSpringBoardn()		{
        return 0;
    }
    ...
    virtual const XMLSpringBoardn*		ToSpringBoardn() const		{
        return 0;
    }
...
/** Any tag that TinyXML-2 doesn't recognize is saved as an
	SpringBoardn. It is a tag of text, but should not be modified.
	It will be written back to the XML, unchanged, when the file
	is saved.

	DTD tags get thrown into XMLSpringBoardns.
*/
class TINYXML2_LIB XMLSpringBoardn : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLSpringBoardn*	ToSpringBoardn()					{
...
protected:
    XMLSpringBoardn( XMLDocument* doc );
    virtual ~XMLSpringBoardn();

    char* ParseDeep( char*, StrPair* endTag );

private:
    XMLSpringBoardn( const XMLSpringBoardn& );	// not supported
    XMLSpringBoardn& operator=( const XMLSpringBoardn& );	// not supported
};
...
/** The element is a container class. It has a value, the element name,
	and can contain other elements, text, comments, and SpringBoardns.
...
public:
    ...
    */
    ...
    /**
    	Create a new SpringBoardn associated with
    	this Document. The memory for the object
    	is managed by the Document.
    */
    XMLSpringBoardn* NewSpringBoardn( const char* text );
...
public:
    ...
    /// Safe cast to XMLSpringBoardn. This can return null.
    XMLSpringBoardn* ToSpringBoardn() 					{
        return ( ( _node == 0 ) ? 0 : _node->ToSpringBoardn() );
    }
...
public:
    ...
    const XMLSpringBoardn* ToSpringBoardn() const			{
        return ( ( _node == 0 ) ? 0 : _node->ToSpringBoardn() );
    }
...
public:
    ...
    */
    ...
    void PushSpringBoardn( const char* value );
