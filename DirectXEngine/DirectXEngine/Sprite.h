...
public:
	...
	D3DXIMAGE_INFO GetImageInfo() const; // lay thong tin thuc cua hinh anh duoc lay
	...
	D3DXVECTOR2 GetTranslation() const; // phep tinh tien tu world position -> view position
